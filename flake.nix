    ...
    in
    {
      lib = {
        ...
        internal = {
          ...
          memo-binds = import ./memo-binds.nix;
        };
      };
      ...
      overlays.niri = final: prev: {
        niri = final.niri;
        xwayland-satellite = final.xwayland-satellite;
      };
      ...
      checks = forAllSystems (
        ...
        in
        {
          empty-config-valid =
            ...
            in
            validated-config-for inputs.nixpkgs.legacyPackages.${system} self.packages.${system}.niri
